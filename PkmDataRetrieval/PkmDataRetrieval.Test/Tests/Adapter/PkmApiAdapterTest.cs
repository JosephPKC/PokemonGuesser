    ...
    public class PkmApiAdapterTest
    {
        ...
        public void GetAll_AllValidTypes_ReturnBasicRetList()
        {
            static void Test<TRet>() where TRet : BaseRetModel
            {
                ...
                IPkmGateway pGateway = PkmGatewayFactory.CreateGateway(new TestPkmApiFactory(configs));
                IEnumerable<BasicRetModel> expected = TestRets.TestBasicRetList;

                //  Act
                IEnumerable<BasicRetModel>? actual = pGateway.GetAll<TRet>();
        ...
        {
            //  Arrange
            IPkmGateway pGateway = PkmGatewayFactory.CreateGateway(new TestPkmApiFactory());

            //  Act
            IEnumerable<BasicRetModel>? actual = pGateway.GetAll<BaseRetModel>();
        ...
        public void GetById_AllValidTypes_DtoFound_ReturnRet()
        {
            static void Test<TDto, TRet>() where TDto : class, IPkmApiDto where TRet : BaseRetModel
            {
                ...
                //  Act
                TRet? actual = pGateway.GetById<TRet>(id);
        ...
        public void GetById_InvalidType_ReturnNull()
        {
            ...
            //  Act
            BaseRetModel? actual = pGateway.GetById<BaseRetModel>(id);
