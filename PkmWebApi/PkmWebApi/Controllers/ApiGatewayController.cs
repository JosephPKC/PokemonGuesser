...
using PkmWebApi.Dtos.Inputs;
using PkmWebApi.Dtos.Results.Game;
using PkmWebApi.Dtos.Results.Guess;
using PkmWebApi.Dtos.Results.Hint;
using PkmWebApi.Dtos.Results.Stats;
using PkmWebApi.Dtos.Results.User;
...
namespace PkmWebApi.Controllers
{
    [ApiController]
    [Route("/api/")]
    public class ApiGatewayController : ControllerBase
    {
        ...
        public IActionResult GetActiveGame([FromQuery] string userId)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public IActionResult CreateNewGame([FromQuery] string userId)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public IActionResult ProcessGuess([FromQuery] string userId, [FromBody] GuessInputDto guess)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public IActionResult RevealHint([FromQuery] string userId, [FromBody] HintInputDto hintToReveal)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public IActionResult ValidateUser(string userId)
        {
